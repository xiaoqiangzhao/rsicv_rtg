...
const RiscvInstructionMetadata RISCV_INSTRUCTION_TABLE[RISCV_INSTRUCTION_COUNT] = {
    ...
    {"mul", static_cast<RiscvOpcode>(51), static_cast<RiscvFunct3>(0), static_cast<RiscvFunct7>(1), RiscvInstructionType::R_TYPE, false, 0, false, 1},
    {"mulh", static_cast<RiscvOpcode>(51), static_cast<RiscvFunct3>(1), static_cast<RiscvFunct7>(1), RiscvInstructionType::R_TYPE, false, 0, false, 1},
    {"mulhsu", static_cast<RiscvOpcode>(51), static_cast<RiscvFunct3>(2), static_cast<RiscvFunct7>(1), RiscvInstructionType::R_TYPE, false, 0, false, 1},
    {"mulhu", static_cast<RiscvOpcode>(51), static_cast<RiscvFunct3>(3), static_cast<RiscvFunct7>(1), RiscvInstructionType::R_TYPE, false, 0, false, 1},
    {"div", static_cast<RiscvOpcode>(51), static_cast<RiscvFunct3>(4), static_cast<RiscvFunct7>(1), RiscvInstructionType::R_TYPE, false, 0, false, 1},
    {"divu", static_cast<RiscvOpcode>(51), static_cast<RiscvFunct3>(5), static_cast<RiscvFunct7>(1), RiscvInstructionType::R_TYPE, false, 0, false, 1},
    {"rem", static_cast<RiscvOpcode>(51), static_cast<RiscvFunct3>(6), static_cast<RiscvFunct7>(1), RiscvInstructionType::R_TYPE, false, 0, false, 1},
    {"remu", static_cast<RiscvOpcode>(51), static_cast<RiscvFunct3>(7), static_cast<RiscvFunct7>(1), RiscvInstructionType::R_TYPE, false, 0, false, 1},
